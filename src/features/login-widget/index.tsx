  ...
  return (
    <>
      <Dialog open={isModalOpen} onOpenChange={(open) => setIsModalOpen(open)}>
        ...
        <DialogContent className="sm:max-w-[425px] sm:h-[450px] overflow-y-auto">
          <DialogHeader>
          ...
          <Tabs defaultValue="login" className="mt-2">
            ...
            <div className="pt-2">
              {/* Login Tab */}
              <TabsContent value="login" tabIndex={-1} className="min-h-[300px]">
                <Tabs defaultValue="remote-signer" className="mt-2">
                  ...
                  <div className="pt-2">
                    <TabsContent value="extension" tabIndex={-1} className="min-h-[200px]">
                      <div className="mt-4" />
                    ...
                    <TabsContent value="remote-signer" tabIndex={-1} className="min-h-[200px]">
                    ...
                    <TabsContent value="secret-key" tabIndex={-1} className="min-h-[200px]">
              ...
              {/* Sign Up Tab */}
              <TabsContent value="signup" tabIndex={-1} className="min-h-[300px]">
